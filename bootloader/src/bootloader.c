...
int main(void)
{
    ...
    float data[21] = {0.0f, 1.0f, 2.0f, 10.0f, -5.0f, 15.0f, 12.0f, 7.0f, -3.0f, -8.0f, -2.0f, 3.0f, 7.0f, 12.0f, 11.0f, 8.0f, 9.0f, 20.0f, 18.0f, 15.0f, 16.0f};

    void *stats = stats_init();

    for (int i = 0; i < 21; i++)
    {
        stats_feed_sample(stats, &data[i]);
    }
